...
const AccordionItem = ({ module, index, openIndex, toggleAccordion }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-[#E5E7EB] overflow-hidden">
      ...
      >
        ...
        <svg
          className={`w-5 h-5 text-[#4F46E5] transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
export default function CurriculumSection() {
  ...
  // ✅ Toggle: clicking open item closes it, clicking another opens it
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/email-subscription', {
        ...
        body: JSON.stringify({ email, section: 'download' }),
      });
  ...
  return (
    <section className="bg-[#F5F7FA] py-14 px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* ✅ Modules Grid — passing openIndex and toggleAccordion as props */}
